global exit, string_length, print_string, print_char, print_newline, print_uint, print_int, string_equals, read_char, read_word, read_string, parse_uint, parse_int, string_copy, print_err
